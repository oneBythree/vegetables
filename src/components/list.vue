...
<template>
    <header class="header mui-bar mui-bar-nav">
        <a v-link="{ path: '/' }" class="mui-icon mui-icon-left-nav mui-pull-left"></a>
    ...
    <div class="mui-content">
              <ul class="mui-table-view">
                <li class="mui-table-view-cell">
                    <a class="mui-navigate-right"  v-link="{ path: '/into' }"><i class="iconfont icon-into"></i> 蔬菜进场管理 </a>
                </li>
                <li class="mui-table-view-cell">
                    <a class="mui-navigate-right"><i class="iconfont icon-test"></i> 蔬菜检测管理 </a>
                </li>
                <li class="mui-table-view-cell">
                    <a class="mui-navigate-right"><i class="iconfont icon-deal"></i> 蔬菜交易管理 </a>
                </li>
            </ul>
